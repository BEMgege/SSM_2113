...
--%>
						...
						<span><a class="deleteUser" href="javascript:;" username=${user.userName} userid=${user.id}><img src="${pageContext.request.contextPath}/statics/images/schu.png" alt="删除" title="删除"/></a> </span>
						</td>
					</tr>
				</c:forEach>
			</table>
